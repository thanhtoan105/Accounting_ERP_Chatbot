...
import { z } from 'zod'
import { getCompanySettings, updateCompanySettings, type Company } from '@/services/company'
...
export default function CompanySettings() {
  ...
  const handleNavigationAttempt = (_targetPath: string | number) => {
    if (isDirty) {
          ...
          {hasCompany ? (
            ...
            <Alert className="text-muted-foreground">
              {t(
                ...
                'You do not have access to company settings. Please contact your administrator.',
              )}
            </Alert>
          )}
        </CardContent>
