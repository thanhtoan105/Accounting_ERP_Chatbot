...
import { getCustomerById, getCustomerARSummary } from '@/features/customers/services/customer'
                  ...
                  <div className="space-y-4">
                      ...
                      <FieldContent>
                        <div className="px-3 py-2 rounded-md border bg-muted/30">
                          <span className="text-sm font-medium">
                            {formatCurrency(arSummary.totalOwed)}
                          </span>
                        </div>
                      </FieldContent>
                    </Field>
                    ...
                    <Field className="gap-2">
                      ...
                      <FieldContent>
                        <div className="px-3 py-2 rounded-md border bg-muted/30">
                          <span className="text-sm font-medium">
                            {arSummary.averagePaymentDays} days
                          </span>
                        </div>
                      </FieldContent>
                    </Field>
