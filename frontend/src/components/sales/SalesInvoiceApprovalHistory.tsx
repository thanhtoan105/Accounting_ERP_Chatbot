...
import { getApprovalHistory, type ApprovalWorkflowDTO } from '@/services/salesInvoice'

interface SalesInvoiceApprovalHistoryProps {
  invoiceId: string
}
...
export function SalesInvoiceApprovalHistory({ invoiceId }: SalesInvoiceApprovalHistoryProps) {
  ...
  if (workflows.length === 0) {
    return (
      <Card>
        <CardHeader>
          <CardTitle>Approval Workflow History</CardTitle>
          <CardDescription>No approval workflow history for this invoice</CardDescription>
        </CardHeader>
      </Card>
    )
  }
  ...
  return (
    <Card>
      <CardHeader>
        <CardTitle>Approval Workflow History</CardTitle>
        <CardDescription>
          Track all approval requests and decisions for this sales invoice
        </CardDescription>
      </CardHeader>
      <CardContent>
