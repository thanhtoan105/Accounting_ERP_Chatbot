        ...
        <>
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>
                        Manually trigger reminder emails for overdue invoices
                    </CardDescription>
                </CardHeader>
                <CardContent className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <div className="flex flex-wrap gap-2">
                            ...
                            {!hasSelection && (
                                <Badge variant="outline">All Overdue Customers</Badge>
                            )}
                        </div>
                    </div>
                        ...
                        <AlertDescription>
                            {hasSelection ? (
                                <>
                                    ...
                                    {selectedCustomerIds.length > 0 ? 'customers' : 'invoices'}.
                                    Only overdue invoices will be included in the reminders.
                                </>
                            ) : (
                                <>
                    ...
                    <div className="rounded-lg border p-4 space-y-2">
                        ...
                        <div className="text-sm text-muted-foreground space-y-1">
                            <p>• <strong>Subject:</strong> Payment Reminder - [Company Name]</p>
                            <p>• <strong>Content:</strong> Professional reminder with invoice details</p>
                            <p>• <strong>Includes:</strong> Invoice table, amounts, due dates, days overdue</p>
                            <p>• <strong>Format:</strong> HTML email with company branding</p>
                        </div>
                    </div>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription className="space-y-2">
                            <p>
                                Are you sure you want to send reminder emails?
                            </p>
                            <p className="font-semibold">
                                {hasSelection ? (
                                    ...
                                    <>
                                        This will send reminders to <span className="text-orange-600">ALL customers</span> with overdue invoices.
                                    </>
                                )}
                            </p>
