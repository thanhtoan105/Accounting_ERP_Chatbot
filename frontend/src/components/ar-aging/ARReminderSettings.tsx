        ...
        return (
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Configure automated reminder schedules for overdue invoices</CardDescription>
                </CardHeader>
                <CardContent>
            ...
            <CardContent>
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="space-y-2">
                        <Label htmlFor="preDueDays">
                            Pre-Due Reminder (Days Before Due Date)
                        </Label>
                        <Input
                            id="preDueDays"
                            type="number"
                    ...
                    <div className="flex items-center justify-between space-x-4">
                        <div className="flex-1 space-y-1">
                            ...
                            <p className="text-sm text-muted-foreground">
                                Send reminder on the invoice due date
                            </p>
                        </div>
                        <Switch
                            id="dueDateEnabled"
                            checked={dueDateEnabled}
                            onCheckedChange={(checked) => setValue('dueDateEnabled', checked, { shouldDirty: true })}
                        />
                    </div>
                    ...
                    {/* Post-Due Cadence */}
                    <div className="space-y-2">
                        <Label htmlFor="postDueCadenceDays">
                            Post-Due Reminder Cadence (Days)
                        </Label>
                        <Input
