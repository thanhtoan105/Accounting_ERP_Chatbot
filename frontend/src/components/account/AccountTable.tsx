...
import { ChevronRight, ChevronDown, ArrowUpDown, ArrowUp, ArrowDown, ChevronLeft, ChevronsLeft, ChevronsRight } from 'lucide-react'
import {
    Table,
    TableBody,
    TableCell,
...
const getAccountTypeBadgeVariant = (type: string): 'default' | 'secondary' | 'destructive' | 'outline' | 'success' | 'warning' => {
    switch (type) {
        case 'Asset':
        ...
        <div className="rounded-md border">
            ...
            <div className="flex items-center justify-between px-4 py-4 border-t">
                <div className="text-sm text-muted-foreground">
                    Total: <strong className="text-foreground">{totalCount ?? allFlattenedAccounts.length}</strong> records
                </div>
