...
const mockCustomers = [
  { id: 'customer-001', name: 'Test Customer AR', arAccount: '131' },
];

const mockAccounts = [
  { id: 'bank-001', accountCode: '111', name: 'Test Bank', balance: 50000000 },
];
...
test.describe('ReceiptForm Component', () => {
  ...
  test('AC1: should filter customer picker to customers with open invoices', async ({ mount, page }) => {
  ...
  test('AC3: should hide standalone receipt toggle for non-admin users', async ({ mount, page }) => {
