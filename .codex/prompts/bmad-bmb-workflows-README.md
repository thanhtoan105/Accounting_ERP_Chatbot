...
- Path: `.bmad/bmb/workflows/create-agent/data/reference/workflows/meal-prep-nutrition/workflow.md`
...
**create-agent**
- Path: `.bmad/bmb/workflows/create-agent/workflow.md`
