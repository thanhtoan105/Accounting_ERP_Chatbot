...
/**
 * PurchaseBillAttachment entity representing file attachments for purchase bills.
 * Attachments are stored in Supabase Storage with metadata in the database.
 */
@Entity
@Table(name = "purchase_bill_attachments")
public class PurchaseBillAttachment implements CompanyScopedEntity {
