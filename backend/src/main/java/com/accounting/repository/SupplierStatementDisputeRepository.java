...
public interface SupplierStatementDisputeRepository
   ...
   * @return page of disputes
   */
  Page<SupplierStatementDispute> findByCompanyIdAndSupplierId(
   ...
   * @return page of disputes
   */
  Page<SupplierStatementDispute> findByCompanyIdAndSupplierIdAndStatus(
      Long companyId,
      Long supplierId,
      SupplierStatementDispute.DisputeStatus status,
      Pageable pageable);
   ...
   */
  @Query(
      "SELECT d FROM SupplierStatementDispute d "
   ...
   */
  @Query(
      "SELECT COUNT(d) FROM SupplierStatementDispute d "
          + "WHERE d.companyId = :companyId AND d.supplierId = :supplierId "
          + "AND d.status IN ('OPEN', 'IN_PROGRESS')")
   ...
   */
  List<SupplierStatementDispute> findByCompanyIdAndBillId(Long companyId, UUID billId);
}
