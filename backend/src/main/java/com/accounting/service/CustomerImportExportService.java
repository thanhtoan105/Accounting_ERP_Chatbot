...
public interface CustomerImportExportService {
   ...
   */
  void exportCustomers(List<CustomerDTO> customers, String format, OutputStream outputStream);
   ...
   */
  ImportResult importCustomers(InputStream inputStream, String filename);
